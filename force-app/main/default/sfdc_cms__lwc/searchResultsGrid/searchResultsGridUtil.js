...
export function generateNumberForGridLayout(numberOfColumns) {
  const desktopCards = [2, 3, 4];
  const layoutIndex = ['fewer', 'default', 'more'].indexOf(numberOfColumns);
  return layoutIndex !== -1 ? desktopCards[layoutIndex] : 3;
}