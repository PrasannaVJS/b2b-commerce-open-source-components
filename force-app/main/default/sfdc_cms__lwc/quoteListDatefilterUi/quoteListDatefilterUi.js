...
export default class QuoteListDatefilterUi extends LightningElement {
  ...
  renderedCallback() {
    ...
    if (container) {
      this._layoutAlignment = getComputedStyle(container).getPropertyValue('--quote-list-filter-layout-alignment');
    }
  }
  connectedCallback() {
