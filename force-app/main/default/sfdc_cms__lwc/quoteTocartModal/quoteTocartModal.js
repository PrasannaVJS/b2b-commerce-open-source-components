...
import cartAlreadyContainsQuoteItemsErrorMessage from '@salesforce/label/site.quoteTocartModal.cartAlreadyContainsQuoteItemsErrorMessage';
import subscriptionProductsNotSupportedErrorMessage from '@salesforce/label/site.quoteTocartModal.subscriptionProductsNotSupportedErrorMessage';
import subscriptionProductCheckFailedErrorMessage from '@salesforce/label/site.quoteTocartModal.subscriptionProductCheckFailedErrorMessage';
import duplicateToCartWithInactiveProductFailed from '@salesforce/label/site.quoteTocartModal.duplicateToCartWithInactiveProductFailed';
import acceptAndBuyOperationErrorMessage from '@salesforce/label/site.quoteTocartModal.acceptAndBuyOperationErrorMessage';
import duplicateCartOperationErrorMessage from '@salesforce/label/site.quoteTocartModal.duplicateCartOperationErrorMessage';
import duplicateProductInCartErrorMessage from '@salesforce/label/site.quoteTocartModal.duplicateProductInCartErrorMessage';
import cartCreationFailedErrorMessage from '@salesforce/label/site.quoteTocartModal.cartCreationFailedErrorMessage';
import outOfStockError from '@salesforce/label/site.quoteTocartModal.outOfStockError';
...
export default class QuoteTocartModal extends LightningModal {
  @api
  mode = 'acceptQuote';
  @api
  quoteId;
